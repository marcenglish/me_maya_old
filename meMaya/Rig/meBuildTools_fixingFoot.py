...
def Joints(obj,skelType,**kwargs):    
    id = obj.id
    new = ''
    jointSet = {'FK':obj.FKJ,'IK':obj.IKJ,'Rig':obj.RigJ,'Post_IK':obj.PIKJ,'PreIK':obj.PreIKJ,'Rtrn_IK':obj.RtrnIKJ}
...
def Framework(obj):        
    ...
    if m.objExists(obj.name+id+"_Utils") is True:
        ...
        meTools.Ctrl(name=obj.name+id+'_plug_end_IN',color='white',shape='locator',tgt=obj.baseJ[-1],parentSpace=obj.utilsTop,vis=1,lockType='')
        obj.name+id+'_plug_end_IN'
